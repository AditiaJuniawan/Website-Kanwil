...
<head>
    ...
    <title>Website Sedang dalam Perbaikan — Kanwil Ditjenpas Banten</title>
    ...
    <div class="max-w-2xl w-full text-center relative z-10" data-aos="zoom-in">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 p-8 md:p-12 relative overflow-hidden">
            ...
            <div class="relative w-36 h-36 mx-auto mb-8 flex items-center justify-center">
                ...
                <!-- Mini Floating Badge -->
                <div class="absolute bottom-1 right-1 bg-amber-500 text-white w-10 h-10 rounded-full flex items-center justify-center shadow-md animate-bounce">
            ...
            <p class="text-slate-500 text-sm md:text-base leading-relaxed mb-8 max-w-lg mx-auto">
                Kami sedang melakukan pemeliharaan rutin dan pembaruan sistem untuk meningkatkan performa layanan digital kami. Mohon maaf atas ketidaknyamanan ini, kami akan segera kembali secepatnya.
            </p>
            ...
            <div class="bg-slate-50 border border-slate-100 rounded-2xl p-4 mb-8 flex items-center justify-center gap-3 max-w-md mx-auto">
                ...
                <span class="text-xs md:text-sm font-semibold text-slate-700 uppercase tracking-wide">
                    Status Layanan: PEMELIHARAAN SISTEM
                </span>
            </div>

            <!-- Call to Actions -->
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="tel:082266662055" class="bg-brand-700 hover:bg-brand-800 text-white font-bold px-8 py-3.5 rounded-full transition-all text-sm shadow-md shadow-brand-700/20 flex items-center justify-center">
                    <i class="fa-solid fa-phone mr-2"></i> Call Center
                </a>
                <a href="https://wa.me/6282266662055" target="_blank" class="bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-3.5 rounded-full transition-all text-sm shadow-md shadow-green-600/20 flex items-center justify-center">
                    <i class="fa-brands fa-whatsapp mr-2"></i> WhatsApp Pengaduan
                </a>
            </div>
        </div>
