...
@section('content')
    ...
    <div class="SOP">
        ...
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSd80rCHwrVXwEcdPEeeE4r2TvM9lH9sH1qg4NKvuc5iE2G_bw/viewform?usp=send_form" class="btn-layanan" target="_blank">> KLIK DISINI UNTUK PENGAJUAN INFORMASI <</a>
    </div>
